  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
          ...
          children: [
            ...
            Expanded(
              child: switch (state) {
                ...
                SurveyListLoaded(:final surveys) =>
                  _DashboardSurveyList(
                    surveys: surveys,
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () => context.push(AppRoutes.createSurvey),
      ...
      child: ConstrainedBox(
        ...
        child: ListView.separated(
          ...
          itemBuilder: (context, index) => SurveyCard(
            ...
            isDeleteLoading: deletingIds.contains(
              surveys[index].id,
            ),
          ),
  ...
  final confirmed = await showDialog<bool>(
    ...
    builder: (context) {
      return AlertDialog(
        ...
        content: Text(
          'Delete the survey for ${survey.farmerName}?',
        ),
        actions: [
          TextButton(
